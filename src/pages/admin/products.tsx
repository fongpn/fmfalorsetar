...
// Update the Product type to match the database schema
...
export default function ProductsPanel() {
  ...
  const toggleProductStatus = async (product: Product) => {
    try {
      ...
      toast({
        title: 'Success',
        description: `Product ${product.active ? 'disabled' : 'enabled'}`,
      });
    } catch (error) {
  ...
  const handleExportCSV = () => {
    const exportData = products.map(({ id, image_url, ...product }) => ({
      ...product,
